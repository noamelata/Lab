...
# SW
#============================================================
set_location_assignment PIN_AB30 -to en ; #SW[0]
...
# LED
#============================================================ 
set_location_assignment PIN_AA24 -to q[0] ; #LEDR[0]  
set_location_assignment PIN_AB23 -to q[1] ; #LEDR[1]
set_location_assignment PIN_AC23 -to q[2] ; #LEDR[2]
set_location_assignment PIN_AD24 -to q[3] ; #LEDR[3]
set_location_assignment PIN_AG25 -to qs[0] ; #LEDR[4]
set_location_assignment PIN_AF25 -to qs[1] ; #LEDR[5]
set_location_assignment PIN_AE24 -to qs[2] ; #LEDR[6]
set_location_assignment PIN_AF24 -to qs[3] ; #LEDR[7]
set_location_assignment PIN_AB22 -to equal ; #LEDR[8]
