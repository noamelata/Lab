...
set_location_assignment PIN_AB23 -to FastCount[0] ;#fastCo[0] ;#LEDR[1]
set_location_assignment PIN_AC23 -to FastCount[1] ;#fastCo[1] ;#LEDR[2]
set_location_assignment PIN_AD24 -to FastCount[2] ;#fastCo[2] ;#LEDR[3]
set_location_assignment PIN_AG25 -to FastCount[3] ;#fastCo[3] ;#LEDR[4]
