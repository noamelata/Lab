...
# LED
#============================================================ #LEDR[0]
set_location_assignment PIN_AA24 -to Output[0] ;#LEDR[0]
set_location_assignment PIN_AB23 -to Output[1] ;#LEDR[1]
set_location_assignment PIN_AC23 -to Output[2] ;#LEDR[2]
set_location_assignment PIN_AD24 -to Output[3] ;#LEDR[3]
set_location_assignment PIN_AG25 -to LEDR[4]
set_location_assignment PIN_AF25 -to Output[4] ;#LEDR[5]
set_location_assignment PIN_AE24 -to Output[5] ;#LEDR[6]
set_location_assignment PIN_AF24 -to Output[6] ;#LEDR[7]
set_location_assignment PIN_AB22 -to Output[7] ;#LEDR[8]
