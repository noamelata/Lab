...
set_location_assignment PIN_AB28 -to darkN ;#SW[2]
set_location_assignment PIN_AC30 -to lampTest ;#SW[3]
...
# LED
#============================================================ #LEDR[0]
set_location_assignment PIN_AA24 -to redLight ;#LEDR[0] 
set_location_assignment PIN_AB23 -to yellowLight ;#fastCo[0] ;#LEDR[1]
set_location_assignment PIN_AC23 -to greenLight ;#fastCo[1] ;#LEDR[2]
set_location_assignment PIN_AD24 -to count[2] ;#fastCo[2] ;#LEDR[3]
set_location_assignment PIN_AG25 -to count[3] ;#fastCo[3] ;#LEDR[4]
set_location_assignment PIN_AF25 -to slowCo[0] ;#LEDR[5]
set_location_assignment PIN_AE24 -to slowCo[1] ;#LEDR[6] 
set_location_assignment PIN_AF24 -to slowCo[2] ;#LEDR[7] 
set_location_assignment PIN_AB22 -to slowCo[3] ;#LEDR[8] 
set_location_assignment PIN_AC22 -to duty50 ;#LEDR[9]
